...
function loadTabContent(sampleData) {
    ...
    let cshtml = getResponse(getBasePath() + 'Views/' + sampleData.routerPath + '/Index.aspx?=sourceTab');
    let csharp = getResponse(getBasePath() + 'Views/' + sampleData.routerPath + '/Index.aspx.cs');
...
function updateMetaData(sampleData) {
    document.title = sampleData.sampleName + ' | Reports for ASP.NET WebForms | Syncfusion';
