...
<SF:ReportViewer runat="server" ID="Reports" ReportPath="product-line-sales" ReportServiceUrl='<%# Globals.SERVICE_URL %>' OnClientToolbarRendering="onToolbarRendering" OnClientToolBarItemClick="onToolBarItemClick"></SF:ReportViewer>
