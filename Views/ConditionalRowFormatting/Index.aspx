...
<SF:ReportViewer runat="server" ID="Reports" ReportPath="conditional-row-formatting" ReportServiceUrl='<%# Globals.SERVICE_URL %>' OnClientToolbarRendering="onToolbarRendering" OnClientToolBarItemClick="onToolBarItemClick"></SF:ReportViewer>
